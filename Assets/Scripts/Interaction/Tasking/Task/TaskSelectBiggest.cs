...
public class TaskSelectBiggest : DiscreteGestureInteractionTask
{
    ...
    public override IEnumerator Perform(SpeechInteractionEventArgs eventArgs)
    {
        ...
        int max = bundles.Max(b => b.CompilationUnitCount);
        var bundle = bundles.First(b => b.CompilationUnitCount == max);
