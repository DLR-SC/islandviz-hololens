...
Shader "Custom/MRTK_Standard_Fade"
{
    Properties
    {
        // Main maps.
        ...
        // Advanced options.
        [Enum(RenderingMode)] _Mode("Rendering Mode", Float) = 2                                     // "Transparent"
        [Enum(CustomRenderingMode)] _CustomMode("Mode", Float) = 2                                   // "Transparent"
        [Enum(UnityEngine.Rendering.BlendMode)] _SrcBlend("Source Blend", Float) = 5                 // "SrcAlpha"
        [Enum(UnityEngine.Rendering.BlendMode)] _DstBlend("Destination Blend", Float) = 10           // "OneMinusSrcAplha"
        [Enum(UnityEngine.Rendering.BlendOp)] _BlendOp("Blend Operation", Float) = 0                 // "Add"
        [Enum(UnityEngine.Rendering.CompareFunction)] _ZTest("Depth Test", Float) = 4                // "LessEqual"
        [Enum(DepthWrite)] _ZWrite("Depth Write", Float) = 0	                                     // "Off"
        [Enum(UnityEngine.Rendering.ColorWriteMask)] _ColorWriteMask("Color Write Mask", Float) = 15 // "All"
        [Enum(UnityEngine.Rendering.CullMode)] _CullMode("Cull Mode", Float) = 2                     // "Back"
        _RenderQueueOverride("Render Queue Override", Range(-1.0, 5000)) = 3001
    ...
    SubShader
    {
        Pass
        {
            Tags{ "Queue" = "Transparent" "RenderType" = "Opaque" "LightMode" = "ForwardBase" "PerformanceChecks" = "False" }
            LOD 100
