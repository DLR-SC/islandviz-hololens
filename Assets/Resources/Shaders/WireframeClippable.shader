...
///
Shader "Custom/WireframeClippable"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            {
				float distBottom = dot(i.worldPos.xyz - _PositionClipBottom, _NormalClipBottom);
				float distFront = dot(i.worldPos.xyz - _PositionClipFront, _NormalClipFront);
				float distBack = dot(i.worldPos.xyz - _PositionClipBack, _NormalClipBack);
				float distLeft = dot(i.worldPos.xyz - _PositionClipLeft, _NormalClipLeft);
				float distRight = dot(i.worldPos.xyz - _PositionClipRight, _NormalClipRight);
